...
<html>
    ...
    <body class="bg-gray-900 min-h-screen text-white flex flex-col">
                ...
                <div class="w-full max-w-3xl space-y-6">
                    ...
                    <div class="bg-gray-800 border border-gray-700 rounded-xl p-8 shadow-lg">
                        ...
                        <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- US State dropdown -->
                            <div>
                                <label class="text-xs text-gray-400">* State/State Adjacent</label>
                             <input required type="text" name="state" value="<?= htmlspecialchars($state) ?>" class="w-full mt-2 h-12 bg-gray-900 border border-gray-700 rounded-lg px-4 text-sm text-white placeholder-gray-500 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                            </div>
                            ...
                            <div>
                                <label class="text-xs text-gray-400">* ZIP</label>
                                     <input
                                          ...
                                          class="w-full mt-2 h-12 bg-gray-900 border border-gray-700 rounded-lg px-4 text-sm text-white placeholder-gray-500 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                                        </div>
        ...
        <script>
            // Format the ZIP code as the user types.
